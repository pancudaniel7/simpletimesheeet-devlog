...
Next I open the web layer and explain the framework choice: why Fiber v3 won on API design, what running on fasthttp actually costs, and a benchmark against Rust, Node and Python that refused to measure what I wanted it to.
